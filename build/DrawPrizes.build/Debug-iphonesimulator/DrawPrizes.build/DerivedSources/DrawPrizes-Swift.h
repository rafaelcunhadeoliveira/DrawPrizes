...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DrawPrizes",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10DrawPrizes11AppDelegate")
...
SWIFT_CLASS("_TtC10DrawPrizes10DrawButton")
...
SWIFT_CLASS("_TtC10DrawPrizes11DrawSuccess")
@interface DrawSuccess : UIView
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified resultLabel;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified sortAgainButton;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (IBAction)sortAgain:(id _Nonnull)sender;
@end
...
SWIFT_CLASS("_TtC10DrawPrizes22ItemSortViewController")
@interface ItemSortViewController : UIViewController
...
@property (nonatomic, weak) IBOutlet DrawButton * _Null_unspecified sortButton;
...
@interface ItemSortViewController (SWIFT_EXTENSION(DrawPrizes)) <UITableViewDataSource>
...
SWIFT_CLASS("_TtC10DrawPrizes24NumberSortViewController")
@interface NumberSortViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified startNumberTextField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified endNumberTextField;
@property (nonatomic, weak) IBOutlet DrawButton * _Null_unspecified sortButton;
- (void)viewDidLoad;
- (IBAction)sort:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC10DrawPrizes13SceneDelegate")
...
@interface UIViewController (SWIFT_EXTENSION(DrawPrizes))
- (void)hideKeyboard;
@end
